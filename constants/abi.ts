export const WIZPAY_ABI = [
  {
    inputs: [
      { internalType: "address", name: "_fxEngine", type: "address" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "oldEngine", type: "address" },
      { indexed: true, internalType: "address", name: "newEngine", type: "address" },
    ],
    name: "FXEngineUpdated",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "oldCollector", type: "address" },
      { indexed: true, internalType: "address", name: "newCollector", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "address", name: "_fxEngine", type: "address" }],
    name: "updateFXEngine",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
